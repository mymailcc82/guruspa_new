<aside class="page-bnr">
    <div class="content-width">
        <div class="com-bnr-sec06-bottom">
            ...
            <div class="sec06-bottom-col sec06-bottom-col--news">
                <div class="sec-01-col-under">
                    <a href="<?php echo home_url(); ?>/archive/">
                        <div class="sec-01-col-under-img">
                            <picture>
                                <source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/bnr/page-bnr-news-img-sp.png">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/bnr/page-bnr-news-img.png" alt="">
                            </picture>
                        </div>

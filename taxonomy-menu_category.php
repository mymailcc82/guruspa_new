            ...
            <div class="menu-wrap">
                        ...
                        <?php if (!empty($terms) && !is_wp_error($terms)) : ?>
                            <ul class="menu-category-list">
                                <li class="menu-category-item">
                                    <a href="<?php echo home_url(); ?>/menu/">すべて</a>
                                </li>
                                <?php foreach ($terms as $term) : ?>
                                    <li class="menu-category-item">
                                        ...
                                        ?>
                                        <a href="<?php echo esc_url(get_term_link($term)); ?>" <?php echo $active_class; ?>>
                ...
                <div class="menu-wrap-right">
                    ...
                    $args = array(
                        ...
                        'order' => 'DESC', // 降順
                        //menu_category タクソノミーの特定のタームに絞る場合は以下を追加
                        'tax_query' => array(
                            array(
                                'taxonomy' => 'menu_category', // タクソノミーのスラッグを指定
                                'field' => 'slug', // スラッグで指定
                                'terms' => $current_term_slug, // 取得したいタームのスラッグを指定
                            ),
                        )
                    );
                    ?>
                    ...
                    ?>
                    <p class="menu-total-posts"><?php echo $current_term_name; ?>（全<?php echo $total_posts; ?>件）</p>
